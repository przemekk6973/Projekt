...
public class PlantGenerator {
    ...
    public void generatePlantsOnStart(int numOfPlants)
    {
        ...
        for (int x = 0; x < height; x++) {
            for (int y = 0; y < width; y++) {
                ...
                toGrowPlantList.put(new Vector2d(x,y), 0);
            }
        }
    ...
    public void generateToxicCorpes(int growPlant)
    {
        ...
        int i =0;
        System.out.println(numOfPrefferedField);
            ...
            for (int j = 0; j < growPlant; j++) {
                ...
                if(unprefferedField.size() > 0 && preferredField.size() > 0) {
                    if (randomNum <= 1) {
                        ...
                        System.out.println(unprefferedField.size());
    ...
    public void markAsDeathField(Vector2d position)
    {
        ...
        System.out.println("Dlugosc" + toGrowPlantList.size() + " dlugosc elementu " + toGrowPlantList.get(position));
